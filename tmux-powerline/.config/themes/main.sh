...
#TMUX_POWERLINE_DEFAULT_BACKGROUND_COLOR="#ffffff"
...
if [ -z "$TMUX_POWERLINE_WINDOW_STATUS_CURRENT" ]; then
	TMUX_POWERLINE_WINDOW_STATUS_CURRENT=(
		"#[$(format inverse)]"
		#"#[bg=TMUX_POWERLINE_DEFAULT_FOREGROUND_COLOR fg=TMUX_POWERLINE_DEFAULT_BACKGROUND_COLOR nobold noitalics nounderscore]"
		"$TMUX_POWERLINE_DEFAULT_LEFTSIDE_SEPARATOR"
		" #I#F "
		"$TMUX_POWERLINE_SEPARATOR_RIGHT_THIN"
		" #W "
		"#[$(format regular)]"
		#"#[bg=TMUX_POWERLINE_DEFAULT_BACKGROUND_COLOR fg=TMUX_POWERLINE_DEFAULT_FOREGROUND_COLOR nobold noitalics nounderscore]"
		"$TMUX_POWERLINE_DEFAULT_LEFTSIDE_SEPARATOR"
	)
fi
