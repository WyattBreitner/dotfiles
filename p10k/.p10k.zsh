# Generated by Powerlevel10k configuration wizard on 2024-05-23 at 17:50 EDT.
...
() {
  ...
  typeset -g POWERLEVEL9K_PROMPT_CHAR_OK_{VIINS,VICMD,VIVIS,VIOWR}_FOREGROUND=56
  ...
  typeset -g POWERLEVEL9K_DIR_ANCHOR_FOREGROUND=99
  ...
  function my_git_formatter() {
    ...
    if (( $1 )); then
      ...
      local      clean='%90F'   # green foreground
  ...
  typeset -g POWERLEVEL9K_COMMAND_EXECUTION_TIME_FOREGROUND=38
